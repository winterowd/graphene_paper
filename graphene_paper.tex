...
\eeq
 where the sum is over the six permutations taking us the corner opposite $\eta$. Here $P_{\mu}, P_{\nu}, P_{\lambda}$ are permutations of $\pm t, \pm x, \pm y$ and we have introduced the shift operator
 \beq
\label{ShiftOperator} 
