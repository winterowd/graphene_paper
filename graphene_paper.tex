...
We also studied the fermion quasiparticle propagator. Due to the appearance of a nonzero value for the condensate $\vev{\Bpsi \Psi}$, one expects that the dynamical mass remains finite in the limit that the bare mass vanishes. 
