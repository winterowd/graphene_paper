...
\vspace{-1cm}
  ...
  \vspace{-1.25cm}
\caption{Chiral limit of the chiral condensate $\sigma$ using the $T=0$ extrapolated points. The errors on each point were determined from statistics as well as systematics i.e. choice of model for the zero-temperature extrapolation. The value for the intercept is $0.2721(7)$, and the fit has $\chi^2/\text{d.o.f.} \approx 0.6$. The nonzero intercept indicates a finite value for the condensate in the chiral and zero-temperature limits.}
...
\vspace{-1.2cm}
  ...
  \vspace{-1.25cm}
\caption{The zero-temperature, chirally extrapolated dynamical mass as a function $\sqrt{eB}$. The linear fit depicted gives an intercept which is consistent with zero. This as the dynamical mass  is predicted to vanish in the chiral limit in the absence of an external magnetic field.}
\label{fig:MFvsSqrtB}
\end{figure}
