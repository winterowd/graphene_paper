...
\eeq
 Thus if one trusts the scenario resulting from the gap equation, we could be sampling a ground state which is a superposition of (\ref{Singlet}) and (\ref{Triplet}). 
