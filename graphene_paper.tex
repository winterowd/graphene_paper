...
\beq
\nn
&& \sqrt{2} \tr \left\{ \left(\Gamma^{\dagger}_{\eta},~ B^{\dagger}_{\eta} \right) \left( \begin{array}{c} i\sigma_0 d(\vec{y},-y_0) \\ -i\sigma_0 u(\vec{y},-y_0) \end{array} \right) \right\} \\  && = i (-)^{\eta_0 + \eta_1 + \eta_2} \chi_{\tilde{\eta}}(\vec{y}, -y_0).
\eeq
...
\chi_{\eta}(\vec{y}, y_0) \to i (-)^{\eta_0 + \eta_1 +  \eta_2}\chi_{\tilde{\eta}}(\vec{y}, -y_0),
\eeq
